...
class ColumbiaGasTransmissionNoticesSpider(scrapy.Spider):
    name = "tco_notices"
    ...
    mongo_collection = "ebb_columbia_gas_transmission_notices"
    mongo_unique_fields = ["notice_id"]
    overview_url = "https://ebb.tceconnects.com/infopost/OperationalOverview.aspx?v=1.1&assetid=51"
    fixed_user_agent = (
    ...
    def parse_overview_tab(self, response):
        ...
        if not rows:
            self.logger.warning(
                "No TCO notice rows found after clicking tab critical=%s clicked=%r",
                critical,
        ...
        for row in rows:
            ...
            detail_url = (
                ...
                f"?/InfoPost/NoticesSubreport&pNoticeId={notice_id}&AssetNbr=51"
            )
    ...
    def parse_detail(self, response):
        ...
        notice["name"] = "Columbia Gas Transmission"
        notice["tsp"] = "TCO"
        notice["service_provider"] = "Columbia Gas Transmission"
