...
class LouisianaNoticesSpider(scrapy.Spider):
    name = "louisiana_notices"
    allowed_domains = ["kindermorgan.com"]
    mongo_collection = "ebb_louisiana_notices"
    mongo_unique_fields = ["notice_id"]
    notice_types = {
        "Y": "https://pipeline2.kindermorgan.com/Notices/Notices.aspx?type=C&code=KMLP",
        "N": "https://pipeline2.kindermorgan.com/Notices/Notices.aspx?type=N&code=KMLP",
    }
    ...
    def parse(self, response):
        ...
        for row in response.xpath(
            ...
            params = {"code": "KMLP", "notc_nbr": notice_id}
            url = (
    ...
    def parse_detail(self, response):
        ...
        notice["name"] = "KM Louisiana Pipeline"
        notice["tsp"] = "KMLP"
