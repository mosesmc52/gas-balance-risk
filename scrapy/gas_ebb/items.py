...
class CapacityItem(scrapy.Item):
    ...
    Total_Nomination = scrapy.Field()
    Firm_Nomination_Primary = scrapy.Field()
    Firm_Scheduled_Primary = scrapy.Field()
    Firm_Nomination_Within_Zone = scrapy.Field()
    Firm_Scheduled_Within_Zone = scrapy.Field()
    Firm_Nomination_Outside_Zone = scrapy.Field()
    Firm_Scheduled_Outside_Zone = scrapy.Field()
    Interruptible_Nomination = scrapy.Field()
    Interruptible_Scheduled = scrapy.Field()
    Contracted_Firm_Rights = scrapy.Field()
